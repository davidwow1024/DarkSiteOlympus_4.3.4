...
#ifndef OLYMPUS_MAP_H
#define OLYMPUS_MAP_H
...
class MapInstanced;
class InstanceMap;
namespace Olympus { struct ObjectUpdater; }
...
class Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        void VisitNearbyCellsOf(WorldObject* obj, TypeContainerVisitor<Olympus::ObjectUpdater, GridTypeMapContainer> &gridVisitor, TypeContainerVisitor<Olympus::ObjectUpdater, WorldTypeMapContainer> &worldVisitor);
        ...
        {
            return IsGridLoaded(Olympus::ComputeGridCoord(x, y));
        }
