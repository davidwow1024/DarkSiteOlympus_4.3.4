...
#ifndef OLYMPUS_MAPMANAGER_H
#define OLYMPUS_MAPMANAGER_H
...
class MapManager
{
    ...
    public:
        ...
        {
            return IsValidMAP(mapid, false) && Olympus::IsValidMapCoord(x, y);
        }

        static bool IsValidMapCoord(uint32 mapid, float x, float y, float z)
        {
            return IsValidMAP(mapid, false) && Olympus::IsValidMapCoord(x, y, z);
        }

        static bool IsValidMapCoord(uint32 mapid, float x, float y, float z, float o)
        {
            return IsValidMAP(mapid, false) && Olympus::IsValidMapCoord(x, y, z, o);
        }
