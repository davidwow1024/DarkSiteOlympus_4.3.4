...
{
    OLYMPUS_READ_GUARD(ACE_RW_Thread_Mutex, i_corpseLock);
...
void ObjectAccessor::RemoveCorpse(Corpse* corpse)
{
    ...
    // Critical section
    {
        OLYMPUS_WRITE_GUARD(ACE_RW_Thread_Mutex, i_corpseLock);
        ...
        CellCoord cellCoord = Olympus::ComputeCellCoord(corpse->GetPositionX(), corpse->GetPositionY());
