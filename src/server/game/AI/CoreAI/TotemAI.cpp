...
void TotemAI::UpdateAI(uint32 const /*diff*/)
{
    ...
    {
        victim = NULL;
        Olympus::NearestAttackableUnitInObjectRangeCheck u_check(me, me, max_range);
        Olympus::UnitLastSearcher<Olympus::NearestAttackableUnitInObjectRangeCheck> checker(me, victim, u_check);
