...
std::list<Creature*> ScriptedAI::DoFindFriendlyCC(float range)
{
    ...
    Olympus::CreatureListSearcher<Olympus::FriendlyCCedInRange> searcher(me, list, u_check);
    me->VisitNearbyObject(range, searcher);
...
{
    std::list<Creature*> list;
    Olympus::FriendlyMissingBuffInRange u_check(me, range, uiSpellid);
...
Player* ScriptedAI::GetPlayerAtMinimumRange(float minimumRange)
{
    ...
    Olympus::PlayerAtMinimumRangeAway check(me, minimumRange);
    Olympus::PlayerSearcher<Olympus::PlayerAtMinimumRangeAway> searcher(me, player, check);
    TypeContainerVisitor<Olympus::PlayerSearcher<Olympus::PlayerAtMinimumRangeAway>, GridTypeMapContainer> visitor(searcher);
