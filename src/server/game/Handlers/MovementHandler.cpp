    ...
    if (plrMover)
    {
        ...
        switch (plrMover->GetMapId())
        {
            ...
            case 968:
                ...
                break;
                switch (plrMover->GetAreaId()) // Free Wil'hai attempt quest fix. Not working... https://github.com/AshamaneProject/AshamaneCore/commit/3e04dae4cc720b759c7623349e8c54c03dfa22a5
            case 4815: // Vashj'ir height fixes
            case 4816:
            case 5144:
            case 5145:
            case 5146:
            case 5102:
                underMapValueZ = -2000.0f;
                upperLimitValueZ = MAX_HEIGHT;
                break;
            default:
