...
public:
    ...
    static bool HandleMmapTestArea(ChatHandler* handler, char const* /*args*/)
    {
        ...
        CellCoord pair(Olympus::ComputeCellCoord(object->GetPositionX(), object->GetPositionY()));
        Cell cell(pair);
        cell.SetNoCreate();

        std::list<Creature*> creatureList;

        Olympus::AnyUnitInObjectRangeCheck go_check(object, radius);
        Olympus::CreatureListSearcher<Olympus::AnyUnitInObjectRangeCheck> go_search(object, creatureList, go_check);
        TypeContainerVisitor<Olympus::CreatureListSearcher<Olympus::AnyUnitInObjectRangeCheck>, GridTypeMapContainer> go_visit(go_search);
