            ...
            void WaypointStart(uint32 waypointId)
            {
                ...
                switch (waypointId)
                {
                    ...
                    case 4:
                    {
                        ...
                        Olympus::CreatureListSearcher<FrostwingVrykulSearcher> searcher(me, temp, check);
                ...
                if (!_wipeCheckTimer)
                {
                    ...
                    if (!player)
                    {
                        ...
                        if (damage >= me->GetHealth())
                        {
                            ...
                            Olympus::CreatureWorker<FrostwingGauntletRespawner> worker(me, respawner);
    ...
    public:
                ...
                while (uint32 eventId = Events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_ARNATH_PW_SHIELD:
                        {
                            ...
                            DoCast(Olympus::Containers::SelectRandomContainerElement(targets), SPELL_POWER_WORD_SHIELD);
        ...
        private:
            Creature* FindFriendlyCreature() const
            {
                ...
                Olympus::MostHPMissingInRange u_check(me, 60.0f, 0);
                Olympus::CreatureLastSearcher<Olympus::MostHPMissingInRange> searcher(me, target, u_check);
    ...
    public:
        ...
        class spell_icc_sprit_alarm_SpellScript : public SpellScript
        {
            ...
            void HandleEvent(SpellEffIndex effIndex)
            {
                ...
                wards.sort(Olympus::ObjectDistanceOrderPred(GetCaster()));
    ...
    public:
        ...
        bool OnTrigger(Player* player, AreaTriggerEntry const* /*areaTrigger*/)
        {
            ...
            if (instance->GetData(DATA_COLDFLAME_JETS) == NOT_STARTED)
            {
                ...
                traps.sort(Olympus::ObjectDistanceOrderPred(player));
                bool instant = false;
