                    ...
                    case POINT_AIR_PHASE:
                            ...
                            return;
                        {
                            ...
                            if (threatlist.size())
                            {
                                ...
                                Olympus::Containers::RandomResizeList(targetList, RAID_MODE<uint8>(2, 5, 2, 6));
        ...
        class spell_sindragosa_unchained_magic_SpellScript : public SpellScript
        {
            ...
            void FilterTargets(std::list<WorldObject*>& unitList)
            {
                ...
                if (unitList.size() > maxSize)
                    Olympus::Containers::RandomResizeList(unitList, maxSize);
            }
        ...
        class spell_frostwarden_handler_order_whelp_SpellScript : public SpellScript
        {
            ...
            void HandleForcedCast(SpellEffIndex effIndex)
            {
                ...
                if (!unitList.empty() && GetHitUnit())
                    Olympus::Containers::SelectRandomContainerElement(unitList)->CastSpell(GetHitUnit(), uint32(GetEffectValue()), true);
            }
