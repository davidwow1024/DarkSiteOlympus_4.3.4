        ...
        void UpdateAI(uint32 const diff) override
        {
            ...
            while (uint32 eventid = events.ExecuteEvent())
            {
                ...
                case EVENT_SHATTERED_ICE:
                {
                    Unit *caster = me;
                    std::list<WorldObject *> targetList;
                    Olympus::AllWorldObjectsInRange objects(me, 40.0f);
                    Olympus::WorldObjectListSearcher<Olympus::AllWorldObjectsInRange> searcher(me, targetList, objects, GRID_MAP_TYPE_MASK_PLAYER);
                    ...
                    {
                        if (WorldObject *target = Olympus::Containers::SelectRandomContainerElement(targetList))
...
public:
    ...
    class spell_ds_ice_tomb_selector_SpellScript : public SpellScript
    {
        ...
        void FilterTargets(std::list<WorldObject *> &targets)
        {
            ...
            targets.remove_if(Olympus::UnitAuraCheck(true, SPELL_ICE_TOMB_MISSILE));
            ...
            if (!targets.empty())
                Olympus::Containers::RandomResizeList(targets, targetCount);
        }
...
public:
    ...
    class spell_ds_frostflake_SpellScript : public SpellScript
    {
        ...
        void FilterTargets(std::list<WorldObject *> &targets)
        {
            targets.remove_if(Olympus::UnitAuraCheck(true, SPELL_FROSTFLAKE));
...
public:
    ...
    class spell_ds_lightning_conduit_periodic_AuraScript : public AuraScript
    {
        ...
        void OnPeriodicTick(AuraEffect const * /*aurEff*/)
        {
            ...
            Olympus::AllCreaturesOfEntryInRange checker(GetTarget(), NPC_CRYSTAL_CONDUCTOR, 12.00f);
            Olympus::CreatureListSearcher<Olympus::AllCreaturesOfEntryInRange> searcher(GetTarget(), CreatureList, checker);
