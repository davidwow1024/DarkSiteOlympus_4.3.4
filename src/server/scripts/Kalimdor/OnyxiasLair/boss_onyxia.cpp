            ...
            if (Phase == PHASE_START || Phase == PHASE_END)
            {
                ...
                else
                {
                    if (BellowingRoarTimer <= Diff)
                    {
                        ...
                        Olympus::GameObjectInRangeCheck check(me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(), 15);
                        Olympus::GameObjectLastSearcher<Olympus::GameObjectInRangeCheck> searcher(me, Floor, check);
