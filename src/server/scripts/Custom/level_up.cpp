    ...
    public:
        ...
        bool OnUse(Player* player, Item* item, SpellCastTargets const& /*targets*/)
        {
            if (player->getLevel() < 10)
            {
                ...
                ChatHandler(player->GetSession()).PSendSysMessage("Necesitas selecionar tu especializacion!");
                return true;
            }
            ...
            MailDraft draft("Level UP items", "Gracias por apoyar a Olympus WoW Server!");
            ...
            ChatHandler(player->GetSession()).PSendSysMessage("Revisa tu correo!");
