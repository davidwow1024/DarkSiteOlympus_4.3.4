...
const char* GetSlotName(uint8 slot, WorldSession* /*session*/)
{
	...
	case EQUIPMENT_SLOT_CHEST: return  "Pechera";
	case EQUIPMENT_SLOT_WAIST: return  "Cintura";
	case EQUIPMENT_SLOT_LEGS: return  "Piernas";
	case EQUIPMENT_SLOT_FEET: return  "Botas";
	case EQUIPMENT_SLOT_WRISTS: return  "Brazales";
	case EQUIPMENT_SLOT_HANDS: return  "Manos";
	case EQUIPMENT_SLOT_BACK: return  "Capa";
	case EQUIPMENT_SLOT_MAINHAND: return  "Arma Derecha";
	case EQUIPMENT_SLOT_OFFHAND: return  "Arma Izquierda";
	case EQUIPMENT_SLOT_RANGED: return  "Arma de Rango";
