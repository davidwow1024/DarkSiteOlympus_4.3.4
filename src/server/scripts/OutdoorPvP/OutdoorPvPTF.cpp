...
void OPvPCapturePointTF::ChangeState()
{
    ...
    if (m_OldState == OBJECTIVESTATE_ALLIANCE)
    {
        ...
        sWorld->SendZoneText(OutdoorPvPTFBuffZones[0], sObjectMgr->GetOlympusStringForDBCLocale(LANG_OPVP_TF_LOSE_A));
    }
    ...
    else if (m_OldState == OBJECTIVESTATE_HORDE)
    {
        ...
        sWorld->SendZoneText(OutdoorPvPTFBuffZones[0], sObjectMgr->GetOlympusStringForDBCLocale(LANG_OPVP_TF_LOSE_H));
    }
    ...
    case OBJECTIVESTATE_ALLIANCE:
    {
        ...
        sWorld->SendZoneText(OutdoorPvPTFBuffZones[0], sObjectMgr->GetOlympusStringForDBCLocale(LANG_OPVP_TF_CAPTURE_A));
    ...
    case OBJECTIVESTATE_HORDE:
    {
        ...
        sWorld->SendZoneText(OutdoorPvPTFBuffZones[0], sObjectMgr->GetOlympusStringForDBCLocale(LANG_OPVP_TF_CAPTURE_H));
