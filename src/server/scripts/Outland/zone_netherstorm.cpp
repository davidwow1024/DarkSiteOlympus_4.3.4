...
//TODO: clean up this workaround when Olympus adds support to do it properly (with gossip selections instead of instant summon)
    ...
    struct mob_phase_hunterAI : public ScriptedAI
    {
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            if (ManaBurnTimer <= diff)
            {
                ...
                {
                    DoCast(Olympus::Containers::SelectRandomContainerElement(UnitsWithMana), SPELL_MANA_BURN);
