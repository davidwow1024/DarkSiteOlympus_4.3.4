        ...
        struct npc_simon_bunnyAI : public ScriptedAI
        {
            ...
            */
            void StartGame()
            {
                ...
                Olympus::AllWorldObjectsInRange objects(me, searchDistance);
                Olympus::WorldObjectListSearcher<Olympus::AllWorldObjectsInRange> searcher(me, ClusterList, objects);
