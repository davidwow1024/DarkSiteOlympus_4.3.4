...
#ifndef OLYMPUS_TYPECONTAINER_H
#define OLYMPUS_TYPECONTAINER_H
...
{
    public:
        template<class SPECIFIC_TYPE> size_t Count() const { return Olympus::Count(i_elements, (SPECIFIC_TYPE*)NULL); }

        /// inserts a specific object into the container
        template<class SPECIFIC_TYPE> bool insert(SPECIFIC_TYPE *obj)
        {
            SPECIFIC_TYPE* t = Olympus::Insert(i_elements, obj);
            return (t != NULL);
        }
        ...
        //{
        //    SPECIFIC_TYPE* t = Olympus::Remove(i_elements, obj);
        //    return (t != NULL);
        //}
