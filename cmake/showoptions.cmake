...
message("")
message("* OlympusCore ver. hash  : ${rev_info}")
message("* OlympusCore ver. date  : ${rev_date}")
if( UNIX )
  message("* OlympusCore buildtype  : ${CMAKE_BUILD_TYPE}")
endif()
message("")
...
if( WITH_COREDEBUG )
  ...
  add_definitions(-DOLYMPUS_DEBUG)
else()
